...
def insert_sample_questions():
    ...
    questions = [
        ...
        ("database_admin", "What does NOSQL stand for?", "Not Only SQL", "New Open SQL", "No Operations SQL", "No Official SQL", "Not Only SQL"),
...
if __name__ == "__main__":
    ...
    print("Database and sample questions created successfully.")
